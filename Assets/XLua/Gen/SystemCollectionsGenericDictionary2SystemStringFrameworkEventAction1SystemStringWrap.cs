...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemStringFrameworkEventAction_1_SystemString__Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>(_comparer);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>>(L, 2))
				{
					System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>> _dictionary = (System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>));
					
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>(_dictionary);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>(_capacity);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>> _dictionary = (System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<string, Framework.Event.Action<string>>));
					...
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>(_dictionary, _comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> gen_ret = new System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>(_capacity, _comparer);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>> constructor!");
        ...
        static int _m_set_Item(RealStatePtr L)
        {
		    try {
                ...
                
                {
					...
					string key = LuaAPI.lua_tostring(L, 2);
					gen_to_be_invoked[key] = translator.GetDelegate<Framework.Event.Action<string>>(L, 3);
        ...
        static int _m_TryGetValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _key = LuaAPI.lua_tostring(L, 2);
                    Framework.Event.Action<string> _value;
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.Dictionary<string, Framework.Event.Action<string>>.Enumerator gen_ret = gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, gen_ret);
